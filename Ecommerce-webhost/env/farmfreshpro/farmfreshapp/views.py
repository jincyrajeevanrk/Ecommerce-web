...
#     if request.user.is_authenticated:
#         return HttpResponseRedirect('afterlogin')
#     return render(request, 'user_home.html', {'products': products, 'product_count_in_cart': product_count_in_cart})
...
def product_view(request):
    ...
    if 'product_ids' in request.COOKIES:
        ...
        product_count_in_cart=0
    return render(request,'product.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def search_view(request):
    ...
    if request.user.is_authenticated:
        return render(request,'customer-home.html',{'products':products,'word':word,'product_count_in_cart':product_count_in_cart})
